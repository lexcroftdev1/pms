...
<table border="1" cellpadding="5" cellspacing="2" valign="top" width="90%" style="border-collapse:collapse;overflow:auto;" bordercolor="#efefef" align="center">
    <tr>
        ...
        <th align="center">Amount owed by client</th>
        <th></th>
    </tr>
    <?php if($totalRows_rsProject) do {
            ?>
    <tr>
        <td align="center"><a href="showcreditedprojects.php?ClientId=<?php echo $row_rsProject['ClientId']; ?>"> <?php echo $row_rsProject['ClientName']; ?></a></td>
        <td align="center"><?php echo $row_rsProject[Currency].round($row_rsProject[POTotalNetValue],2); ?></td>
        <td>

            <a href="generateinvoice.php?ClientId=<?php echo $row_rsProject['ClientId']; ?>&view=printable" target="_Blank">Printable</a> | <a href="generateinvoice.php?ClientId=<?php echo $row_rsProject['ClientId']; ?>">Download Invoice</a> | <a href="generateinvoice.php?final=true&ClientId=<?php echo $row_rsProject['ClientId']; ?>">Save As Final & Download Invoice</a>
        </td>
    </tr>
