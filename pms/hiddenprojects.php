...
<form name="form1" method="post">
    ...
    <br clear="all" />
    <div style="float:left;margin-bottom:10px;margin-left:55px;vertical-align:middle;">
  		Sorted by: <? echo common::formSelect('SortOrder', array('DateWhenPosted'=>'Date when posted','ProjectPriorityId'=>'Project Priority','ProjectStatusId'=>'Project Status'),$SortOrder,false,'onchange="document.form1.action=\'hiddenprojects.php?SortOrder=\'+this.value;document.form1.submit();"'); ?>
    </div>
    <div style="float:right;margin-bottom:10px;margin-right:55px;vertical-align:middle;">
  		Filter by:&nbsp;
        <select name="ProjectStatusId" onchange="javascript:document.location='hiddenprojects.php?ProjectStatusId='+this.value;">
        ...
        <? echo common::SelectByEnum('ProjectPriorityId','projectpriority',$ProjectPriorityId,true,'onchange="document.form1.action=\'hiddenprojects.php?ProjectPriorityId=\'+this.value;document.form1.submit();"'); ?>
        <?php
        if(common::isAdmin() === true) {
            echo common::SelectByEnum('ClientId','client',$ClientId,true,'onchange="document.form1.action=\'hiddenprojects.php?ClientId=\'+this.value;document.form1.submit();"');
        }
        ?>
    </div>
    <br clear="all" />
        ...
        <td>
            <div style="margin-left:15px;text-align:left;">
                ...
                <a href="#" onclick="if(confirm('Delete this project?')){document.location='deleteproject.php?ProjectId=<?php echo $row_rsProject['ProjectId']; ?>';}else{void(0);}" title="Delete this project">Delete project</a><br>
                            <?php } ?>
                <a href="#" onclick="if(confirm('Hide this project?')){document.location='unhideproject.php?ProjectId=<?php echo $row_rsProject['ProjectId']; ?>';}else{void(0);}" title="Do not hide this project">UnHide project</a><br>
            </div>
        </td>
    </tr>
