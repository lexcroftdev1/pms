...
<div style="float:left;margin-bottom:10px;margin-left:55px;vertical-align:middle;">
    <h1>Invoice to <?php echo common::getClientNameByClientId($_GET[ClientId]); ?></h1>
</div>
<div style="float:right;margin-right:100px;">
    <a href="generateinvoice.php?ClientId=<?php echo $_GET[ClientId]; ?>">Download Invoice</a>
</div>
