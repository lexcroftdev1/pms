...
define('TEMPLATE_DIR',      	dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'templates');
define('TEMPLATE_C_DIR',      	dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'templates_c');
...
class Smarty
{
     ...
     * @var string
     */
    var $compile_dir     =  TEMPLATE_C_DIR;
