...
if($totalRows_rsProjectAttachment >0)
{
 do { ?>
      <li>
      	<?php echo $row_rsProjectAttachment['AttachmentName']; ?> created on <?php echo $row_rsProjectAttachment['DateWhenCreated']; ?>&nbsp;
...
<form enctype="multipart/form-data" method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td>
      	<a href="javascript:document.form1.submit();void(0);"><img src="images/submit.png" alt="Submit Project"></a>
     </td>
    </tr>
  </table>
