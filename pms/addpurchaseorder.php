...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO purchaseorder (AgreedRate, AgreedDiscount, AgreedDiscountTypeId, AgreedHours, ProjectId,PurchaseOrderStatusId) VALUES (%s, %s, %s, %s, %s,'10')",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table cellpadding="15" cellspacing="1" valign="top" align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="AgreedRate" value="<?php echo $row_rsClient['Rate']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Discount:</td>
      <td><input type="text" name="AgreedDiscount" value="<?php echo $row_rsClient['Discount']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">DiscountType:</td>
      <td><select name="AgreedDiscountTypeId">
        <?php
do {
?>
        <option value="<?php echo $row_rsDiscountType['DiscountTypeId']?>" <?php if (!(strcmp($row_rsDiscountType['DiscountTypeId'], $row_rsClient['DiscountTypeId']))) {echo "SELECTED";} ?>><?php echo $row_rsDiscountType['DiscountType']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="AgreedHours" value="" size="32" /></td>
    </tr>
     <tr>
